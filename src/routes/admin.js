...
// Todas as rotas aqui requerem autenticação + admin
...
// GET /api/admin/users/:id - Obter detalhes de um utilizador
...
router.delete('/users/:id', async (req, res) => {
  try {
    ...
    // Apagar reviews, favoritos e watchlist do utilizador
